# T17 — Mem0 Atomic Fact Extraction

## Context
Mem0 extracts atomic facts from every interaction. Instead of storing raw text, stores 'Steve.relationship.ex = Priya'. Gives +26% memory retrieval accuracy.
