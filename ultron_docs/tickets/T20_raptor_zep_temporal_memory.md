# T20 — RAPTOR + Zep Temporal Memory

## Context
RAPTOR builds hierarchical memory tree for fast retrieval at any scale. Zep adds temporal/episodic indexing. Together they make memory fast and navigable even after 100s of projects.
