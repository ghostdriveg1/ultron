# T15 — Reflexion + Process Reward Models

## Context
Reflexion stores lessons from every failure as structured playbooks. PRMs score every reasoning step in real-time, catching errors before they compound into wrong answers.
