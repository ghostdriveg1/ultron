# T13 — Tree of Thoughts + Graph of Thoughts

## Context
Tree of Thoughts enables +70% reasoning improvement on hard problems. Graph of Thoughts allows non-linear idea merging. Together they give Ultron human-expert-level complex reasoning.
