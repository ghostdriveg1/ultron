# T18 — Zilliz Knowledge Graph (Cognee)

## Context
Cognee knowledge graph stores entity relationships. 'Ghost knows Steve who works at Google' becomes a traversable graph. Critical for codebase dependency understanding.
