# T25 — Token Budget Guardian + Admission Control

## Context
Token budget guardian prevents the '7,000 disaster' (real incident). Hard limits per task type. Integration with quota brain for proactive management.
