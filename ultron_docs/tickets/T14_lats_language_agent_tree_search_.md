# T14 — LATS (Language Agent Tree Search)

## Context
LATS combines Tree of Thoughts with Monte Carlo Tree Search (AlphaGo-style). Simulates multiple approaches in imagination before writing any code. Drastically reduces failed approaches.
