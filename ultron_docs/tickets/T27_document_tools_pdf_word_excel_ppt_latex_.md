# T27 — Document Tools (PDF/Word/Excel/PPT/LaTeX)

## Context
All document creation tools: PDF (WeasyPrint), Word (python-docx), Excel (openpyxl), PowerPoint (python-pptx), LaTeX (pdflatex). All with Pydantic validation and Fast.io storage.
